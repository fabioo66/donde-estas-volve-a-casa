...
public record MascotaInfo(
    ...
    public MascotaInfo(Long id, String nombre, Tipo_mascota tipo, Raza raza, String color, String tamanio, String fotos) {
        this(id, nombre, tipo, raza, color, tamanio, fotos, null, null);
    }
}
